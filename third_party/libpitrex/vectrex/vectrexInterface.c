/* vekterm-vendor: MAP_FAILED is defined upstream only in the Linux branch,
   but common code references it; provide a guarded fallback. */
#ifndef MAP_FAILED
...
// RPi3 / Zero 2 (BCM2837)
uint32_t cpu_pmir = 0,
         cpu0_icr = 0, cpu1_icr = 0, cpu2_icr = 0, cpu3_icr = 0,
	 cpu0_micr = 0, cpu1_micr = 0, cpu2_micr = 0, cpu3_micr = 0;
